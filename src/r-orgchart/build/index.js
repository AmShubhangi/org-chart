...
module.exports = { prefix: 'fas', iconName: 'plus', icon: [448, 512, [], "f067", "M416 208H272V64c0-17.67-14.33-32-32-32h-32c-17.67 0-32 14.33-32 32v144H32c-17.67 0-32 14.33-32 32v32c0 17.67 14.33 32 32 32h144v144c0 17.67 14.33 32 32 32h32c17.67 0 32-14.33 32-32V304h144c17.67 0 32-14.33 32-32v-32c0-17.67-14.33-32-32-32z"] };
...
function getTR(item, allitems, addNew, deleteNode, editNode, addSpace, animation, editingNodeId, changeEditingNodeId, editable, rootEditable, nodeStyle, nodeClassName, btnsStyle, btnsClassName, lineColor) {
    var children = allitems[item.id];
    var colspan = (children ? children.length : 1) * 2;

    var lines = _.map(_.range(0, colspan), function (l, idx) {
        if (idx === 0) {
            return _react2.default.createElement('td', { key: idx, className: 'right-line', style: { borderColor: lineColor } });
        } else if (idx + 1 === colspan) {
            return _react2.default.createElement('td', { key: idx, className: 'left-line', style: { borderColor: lineColor } });
        } else if (idx % 2 === 0) {
            return _react2.default.createElement('td', { key: idx, className: 'right-line top-line', style: { borderColor: lineColor } });
        } else {
            return _react2.default.createElement('td', { key: idx, className: 'left-line top-line', style: { borderColor: lineColor } });
        }
    });

    return _react2.default.createElement(
        'table',
        { className: addSpace ? 'add-space' : '' },
        _react2.default.createElement(
            ...
            _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'td',
                    { colSpan: colspan },
                    _react2.default.createElement(NodeBox, {
                        node: item,
                        addNew: addNew,
            ...
            children && _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'td',
                    { colSpan: colspan },
                    _react2.default.createElement('div', { className: 'down-line', style: { borderColor: lineColor } })
                )
            ),
            ...
            _react2.default.createElement(
                ...
                _.map(children, function (i) {
                    return _react2.default.createElement(
                        ...
                        getTR(i, allitems, addNew, deleteNode, editNode, children.length > 1, false, editingNodeId, changeEditingNodeId, editable, rootEditable, nodeStyle, nodeClassName, btnsStyle, btnsClassName, lineColor)
                    );
                })
            )
        )
...
var OrgChart = function (_Component) {
    ...
    function OrgChart(props) {
        ...
        _this.changeEditingNodeId = function (editingNodeId) {
            if (editingNodeId !== _this.state.editingNodeId) {
                _this.setState({ editingNodeId: editingNodeId });
            }
        };
    ...
    _createClass(OrgChart, [{
        ...
        value: function render() {
            ...
            var groupedData = _.groupBy(this.props.data, 'ParentId');
            var animate = this.props.animation && this.props.data.length <= 1;

            var tables = _.map(groupedData[null], function (item) {
                return _react2.default.createElement(
                    'div',
                    {
                    ...
                    getTR(item, groupedData, _this2.props.addNewChild, _this2.props.deleteNode, _this2.props.editNode, true, animate, _this2.state.editingNodeId, _this2.changeEditingNodeId, _this2.props.editable, _this2.props.rootEditable, _this2.props.nodeStyle, _this2.props.nodeClassName, _this2.props.btnsStyle, _this2.props.btnsClassName, _this2.props.lineColor)
                );
            });
...
OrgChart.propTypes = {
    ...
    addNewChild: _propTypes2.default.func.isRequired,
    deleteNode: _propTypes2.default.func.isRequired,
    editNode: _propTypes2.default.func.isRequired,
    editable: _propTypes2.default.bool.isRequired
};

var NodeBox = function (_Component2) {
    _inherits(NodeBox, _Component2);

    function NodeBox(props) {
        _classCallCheck(this, NodeBox);

        var _this3 = _possibleConstructorReturn(this, (NodeBox.__proto__ || Object.getPrototypeOf(NodeBox)).call(this, props));

        _this3.addNewChild = function () {
            _this3.props.addNew(_this3.state.node.id);
        };

        _this3.deleteNode = function () {
            _this3.props.deleteNode(_this3.state.node);
        };

        _this3.editNode = function () {
            _this3.setState({ editMode: true });
            _this3.props.changeEditingNodeId(_this3.state.node.id);
        };

        _this3.handleChange = function (e) {
            var node = _.cloneDeep(_this3.state.node);
            node.title = e.target.value;
            _this3.setState({ node: node });
        };

        _this3.handleEnterKey = function (e) {
            if (e.key === 'Enter') {
                _this3.done(e);
            }
        };

        _this3.done = function () {
            _this3.props.editNode(_this3.state.node);
            _this3.setState({ editMode: false });
        };

        _this3.cancel = function () {
            _this3.setState({ node: _this3.props.node, editMode: false });
        };
    ...
    _createClass(NodeBox, [{
        ...
        value: function render() {
            ...
            var _props = this.props,
                editingNodeId = _props.editingNodeId,
                changeEditingNodeId = _props.changeEditingNodeId,
                editable = _props.editable,
                rootEditable = _props.rootEditable,
                nodeStyle = _props.nodeStyle,
                nodeClassName = _props.nodeClassName,
                btnsStyle = _props.btnsStyle,
                btnsClassName = _props.btnsClassName;


            return _react2.default.createElement(
                ClickOutsideHandler,
                { action: editingNodeId !== -1 && editingNodeId === node.id ? changeEditingNodeId : null },
                editMode && editable ? _react2.default.createElement(
                    'div',
                    { className: 'node-box ' + nodeClassName, style: nodeStyle },
                    _react2.default.createElement(
                        'div',
                        { className: 'org-node-btns ' + btnsClassName, style: btnsStyle },
                        _react2.default.createElement(_reactFontawesome2.default, { icon: 'check', className: 'icon', onClick: this.done }),
                        _react2.default.createElement(_reactFontawesome2.default, { icon: 'times', className: 'icon', onClick: this.cancel })
                    ),
                    ...
                    'div',
                    { className: 'node-box ' + (this.props.animation ? 'node-animation' : '') + ' ' + nodeClassName, style: nodeStyle },
                    editable && _react2.default.createElement(
                        'div',
                        { className: 'org-node-btns ' + btnsClassName, style: btnsStyle },
                        _react2.default.createElement(_reactFontawesome2.default, { icon: 'plus', className: 'icon', onClick: this.addNewChild }),
                        (node.ParentId !== null || node.ParentId === null && rootEditable) && _react2.default.createElement(_reactFontawesome2.default, { icon: 'pencil-alt', className: 'icon', onClick: this.editNode }),
                        node.ParentId !== null && _react2.default.createElement(_reactFontawesome2.default, { icon: 'trash-alt', className: 'icon', onClick: this.deleteNode })
                    ),
                    _react2.default.createElement(
                        'div',
                        { onClick: (node.ParentId !== null || node.ParentId === null && rootEditable) && editable ? this.editNode : undefined, className: 'node-name-box' },
                        _react2.default.createElement(
                            'p',
                            { className: 'node-name' },
...
NodeBox.propTypes = {
    ...
    addNew: _propTypes2.default.func.isRequired,
    deleteNode: _propTypes2.default.func.isRequired,
    editNode: _propTypes2.default.func.isRequired,
    editingNodeId: _propTypes2.default.number.isRequired,
    changeEditingNodeId: _propTypes2.default.func.isRequired,
    editable: _propTypes2.default.bool.isRequired
};

var ClickOutsideHandler = function (_Component3) {
    _inherits(ClickOutsideHandler, _Component3);

    function ClickOutsideHandler(props) {
        _classCallCheck(this, ClickOutsideHandler);

        var _this4 = _possibleConstructorReturn(this, (ClickOutsideHandler.__proto__ || Object.getPrototypeOf(ClickOutsideHandler)).call(this, props));

        _this4.setWrapperRef = _this4.setWrapperRef.bind(_this4);
        _this4.handleClickOutside = _this4.handleClickOutside.bind(_this4);
        return _this4;
    }
    ...
    _createClass(ClickOutsideHandler, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                'div',
                { ref: this.setWrapperRef, className: 'inline-block' },
                this.props.children
            );
        }
    }]);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* WEBPACK VAR INJECTION */(function(global, process) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__fortawesome_fontawesome__ = __webpack_require__(4);
...
_fontawesome2.default.library.add(_faCheck2.default, _faTimes2.default, _faPlus2.default, _faFolder2.default, _faPencilAlt2.default, _faTrashAlt2.default);

var Rorgchart = function (_React$Component) {
    _inherits(Rorgchart, _React$Component);

    function Rorgchart(props) {
        _classCallCheck(this, Rorgchart);

        var _this = _possibleConstructorReturn(this, (Rorgchart.__proto__ || Object.getPrototypeOf(Rorgchart)).call(this, props));

        _this.add = function (parentId) {
            var newId = _lodash2.default.maxBy(_this.state.data, 'id').id + 1;
            ...
            _this.setState({ data: [].concat(_toConsumableArray(_this.state.data), [newNode]) });
        };

        _this.delete = function (node) {
            var newData = _this.deleteChildren(node, _lodash2.default.cloneDeep(_this.state.data), node.id);
            _lodash2.default.remove(newData, { id: node.id });

            _this.setState({ data: newData });
        };

        _this.edit = function (node) {
            var editIdx = _lodash2.default.findIndex(_this.state.data, { id: node.id });
            var updated = (0, _reactAddonsUpdate2.default)(_this.state, { data: _defineProperty({}, editIdx, { $set: node }) });
    ...
    _createClass(Rorgchart, [{
        ...
        key: 'deleteChildren',
        value: function deleteChildren(n, data, stopNode) {
            var child = _lodash2.default.find(data, { ParentId: n.id });
            var parent = _lodash2.default.find(data, { id: n.ParentId });
            ...
            if (child) {
                ...
                _lodash2.default.remove(data, { id: n.id });
        ...
        value: function render() {
            var _props = this.props,
                ...
                disableRootEdit = _props.disableRootEdit,
                addNewChild = _props.addNewChild,
                deleteNode = _props.deleteNode,
                editNode = _props.editNode,
            ...
            return _react2.default.createElement(_Orgchart2.default, {
                editable: !readonly,
...
Rorgchart.defaultProps = {
    readonly: false,
    disableRootEdit: false,
    data: [{ id: 1, title: 'Root', ParentId: null, users:90 }],
...
Rorgchart.propTypes = {
    ...
    disableRootEdit: _propTypes2.default.bool,
    data: _propTypes2.default.array,
    addNewChild: _propTypes2.default.func,
    deleteNode: _propTypes2.default.func,
    editNode: _propTypes2.default.func,
    animation: _propTypes2.default.bool,
    nodeStyle: _propTypes2.default.object,
    nodeClassName: _propTypes2.default.string,
    btnsStyle: _propTypes2.default.object,
    btnsClassName: _propTypes2.default.string,
    lineColor: _propTypes2.default.string
};
exports.default = Rorgchart;
